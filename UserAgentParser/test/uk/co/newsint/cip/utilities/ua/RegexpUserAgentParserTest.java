...
public class RegexpUserAgentParserTest
{
    ...
    public void testBlackBerryParse() throws Exception
    {
        ...
        assertUserAgentEquals("BlackBerry8520/4.6.1.314 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/301 The Times/1.0",
                new UserAgent(UserAgent.MOBILE, "BlackBerry", "8520", "8520", "OS4", "4.6.1.314", "RIM", "BlackBerry",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.TABLET, "BlackBerry", "PlayBook", "PlayBook", "Android", "2.3.3", "RIM", "BlackBerry",
                        UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN, "en", "gb"));
        // Assert for Playbook.
        assertUserAgentEquals(
                "Mozilla/5.0 (PlayBook; U; RIM Tablet OS 1.0.0; en-US) AppleWebKit/534.11+ (KHTML, like Gecko) Version/7.1.0.7 Safari/534.11+",
                new UserAgent(UserAgent.TABLET, "BlackBerry", "PlayBook", "PlayBook", "RIM Tablet OS", "1.0.0", "RIM",
                        "BlackBerry", UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN, "en", "US"));
    }
    ...
    public void testAndroidParse() throws Exception
    {
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.UNKNOWN, "ARCHOS", "101G9", UserAgent.UNKNOWN, "Android", "3.2.1", "Google", "Safari", "4",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.UNKNOWN, "HTC", "One S", UserAgent.UNKNOWN, "Android", "4.0.3", "Google", "Safari", "4",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.UNKNOWN, "ASUS", "Transformer Pad TF700T", UserAgent.UNKNOWN, "Android", "4.0.3", "Google",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.UNKNOWN, "HTC", "Sensation", UserAgent.UNKNOWN, "Android", "4.0.3", "Google", "Safari",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.UNKNOWN, "SAMSUNG", "GT-I9100", UserAgent.UNKNOWN, "Android", "4.0.3", "Google", "Safari",
                        "4", UserAgent.UNKNOWN, UserAgent.UNKNOWN, "en", "GB"));
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.UNKNOWN, UserAgent.UNKNOWN, "GT-I9300", UserAgent.UNKNOWN, "Android", "4.1.1", "Google",
                        "Safari", "4", UserAgent.UNKNOWN, UserAgent.UNKNOWN, "zh", "CN"));
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.UNKNOWN, UserAgent.UNKNOWN, "GT-I9100", UserAgent.UNKNOWN, "Android", "4.1.1", "Google",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.UNKNOWN, "SAMSUNG", "SGH-I727", UserAgent.UNKNOWN, "Android", "4.0.4", "Google", "Chrome",
    ...
    public void testPCParse() throws Exception
    {
        ...
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 5.2) AppleWebKit/535.12 (KHTML, like Gecko) Maxthon/3.0 Chrome/18.0.966.0 "
                ...
                "Windows", "XP 64-bit", "Microsoft", "Maxthon", "3", UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN,
                UserAgent.UNKNOWN));
        // Assertion for Maxthon browser
        ...
        assertUserAgentEquals("Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.22) Gecko/20090610 SeaMonkey/1.1.17",
                new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.COMPUTER, UserAgent.UNKNOWN, "Linux",
                        UserAgent.UNKNOWN, UserAgent.UNKNOWN, "SeaMonkey", "1", UserAgent.UNKNOWN, UserAgent.UNKNOWN, "en", "US"));
