...
public class CompositeUserAgentParserTest {
	...
	public void testBlackBerryParse() throws Exception {
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.MOBILE, "BlackBerry", "8520",
						"8520", "BlackBerryOS", "4.6.1.314", UserAgent.UNKNOWN,
						UserAgent.UNKNOWN));

		// Assert for version 5.
		assertUserAgentEquals(
				"BlackBerry9105/5.0.0.748 Profile/MIDP-2.1 Configuration/CLDC-1.1 VendorID/125",
				new UserAgent(UserAgent.MOBILE, "BlackBerry", "9105",
						"9105", "BlackBerryOS", "5.0.0.748", UserAgent.UNKNOWN,
						UserAgent.UNKNOWN));
		// Assert for version 6.
		assertUserAgentEquals(
				"BlackBerry9300/6.6.0.124 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/310 The Times/1.0",
				new UserAgent(UserAgent.MOBILE, "BlackBerry", "9300",
						"9300", "BlackBerryOS", "6.6.0.124", UserAgent.UNKNOWN,
						UserAgent.UNKNOWN));

		// Assert for version 9.
		assertUserAgentEquals(
				"BlackBerry9320/9.49.0.31 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/118 The Times/1.0",
				new UserAgent(UserAgent.MOBILE, "BlackBerry", "9320",
						"9320", "BlackBerryOS", "9.49.0.31", UserAgent.UNKNOWN,
						UserAgent.UNKNOWN));
	...
	public void testAppleParse() throws Exception {
		...
		assertUserAgentEquals(
				"Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3_3 like Mac OS X; ja-JP)"
						...
						"iOS", "4.3.3", "Mozilla", UserAgent.UNKNOWN));
		// Assertion for IPhone
		assertUserAgentEquals(
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.TABLET, "Apple", "iPad", "iPad", "iOS",
						"5.1.1", "Mobile Safari", "Safari"));
		// Assertion for iPad
		assertUserAgentEquals(
	...
	public void testPCParse() throws Exception {
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT",
						"6.1", "MSIE", "9.0"));
		...
		assertUserAgentEquals(
				"Mozilla/5.0 (Windows NT 4.0) AppleWebKit/534.30 (KHTML, like Gecko) Chrome/12.0.742.5 "
						...
						UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, "Windows NT", "4.0", "Chrome",
						"12.0.742.5"));
		// Assertion for Chrome browser
		assertUserAgentEquals(
		...
		assertUserAgentEquals(
				"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.0.19) Gecko/2010031422 YFF3 "
						...
						UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, "Windows NT", "5.1", "Firefox",
						"3.0.19"));
		// Assertion for Firefox browser
		assertUserAgentEquals(
		...
		assertUserAgentEquals(
				"Mozilla/5.0 (Windows NT 5.1) AppleWebKit/535.12 (KHTML, like Gecko) Maxthon/3.0 Chrome/18.0.966.0 "
						...
						UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, "Windows NT", "5.1", "Maxthon",
						"3.0"));
		// Assertion for Maxthon browser
		assertUserAgentEquals(
		...
		assertUserAgentEquals(
				"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/534.51.22 (KHTML, like Gecko) Version/5.0.2 "
						...
						UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, "Windows NT", "6.1", "Safari",
						"533.18.5"));
		// Assertion for Safari browser
		assertUserAgentEquals(
		...
		assertUserAgentEquals(
				"101653 Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_4) AppleWebKit/534.57.2 (KHTML, like Gecko) "
						...
						UserAgent.COMPUTER, "Apple", UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, "Mac OS X", "10.7.4", "Safari",
						"534.57.2"));
...
public class CompositeUserAgentParserTest
{
    ...
    public void testBlackBerryParse() throws Exception
    {
        ...
        assertUserAgentEquals("BlackBerry8520/4.6.1.314 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/301", new UserAgent(
                UserAgent.MOBILE, "BlackBerry", "8520", "8520", "BlackBerryOS", "4.6.1.314", UserAgent.UNKNOWN, UserAgent.UNKNOWN));

        // Assert for version 5.
        assertUserAgentEquals("BlackBerry9105/5.0.0.748 Profile/MIDP-2.1 Configuration/CLDC-1.1 VendorID/125", new UserAgent(
                UserAgent.MOBILE, "BlackBerry", "9105", "9105", "BlackBerryOS", "5.0.0.748", UserAgent.UNKNOWN, UserAgent.UNKNOWN));
        // Assert for version 6.
        assertUserAgentEquals("BlackBerry9300/6.6.0.124 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/310 The Times/1.0",
                new UserAgent(UserAgent.MOBILE, "BlackBerry", "9300", "9300", "BlackBerryOS", "6.6.0.124", UserAgent.UNKNOWN,
                        UserAgent.UNKNOWN));

        // Assert for version 9.
        assertUserAgentEquals("BlackBerry9320/9.49.0.31 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/118 The Times/1.0",
                new UserAgent(UserAgent.MOBILE, "BlackBerry", "9320", "9320", "BlackBerryOS", "9.49.0.31", UserAgent.UNKNOWN,
                        UserAgent.UNKNOWN));
    ...
    public void testAppleParse() throws Exception
    {
        ...
        assertUserAgentEquals("Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3_5 like Mac OS X; ca-es) "
                ...
                new UserAgent(UserAgent.MOBILE, "Apple", "iPhone", "iPhone", "iOS", "4.3.5", "Mobile Safari", "5.0.2"));
        ...
        assertUserAgentEquals("Mozilla/5.0 (iPad; CPU OS 5_1_1 like Mac OS X; de-de) AppleWebKit/534.46.0 (KHTML, like Gecko) "
                ...
                "iPad", "iPad", "iOS", "5.1.1", "Mobile Safari", "Safari"));
        // Assertion for iPad
        assertUserAgentEquals("Mozilla/5.0 (iPad; U; CPU OS 4_2_1 like Mac OS X; it-it) AppleWebKit/533.17.9 "
                ...
                UserAgent.TABLET, "Apple", "iPad", "iPad", "iOS", "4.2.1", "Mobile Safari", "Safari"));
        // Assertion for iPod
        assertUserAgentEquals("Mozilla/5.0 (iPod touch; U; CPU iPhone OS 5_1_1 like Mac OS X; zh-CN) "
                ...
                "5.1.1", UserAgent.UNKNOWN, UserAgent.UNKNOWN));
        // Assertion for iPod
        assertUserAgentEquals("Mozilla/5.0 (iPod; CPU iPhone OS 5_0 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) "
                ...
                "iPod", "iOS", "5.0", "Mobile Safari", "Safari"));
        // Expected Our custom ParseException
        // assertUserAgentException("Mozilla/5.0 (iPhone; U; CPU like Mac OS X; ja-JP)"
        // + " Times/1.0.2,platform,unknown");
        // Expected Our custom ParseException
    ...
    public void testPCParse() throws Exception
    {
        ...
        assertUserAgentEquals("Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0)", new UserAgent(UserAgent.COMPUTER,
                UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "6.1", "MSIE", "9.0"));
        // Assertion for Internet Explorer
        assertUserAgentEquals("Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0)", new UserAgent(UserAgent.COMPUTER,
                UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "6.1", "MSIE", "9.0"));
        // Assertion for Chrome browser
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 4.0) AppleWebKit/534.30 (KHTML, like Gecko) Chrome/12.0.742.5 "
                ...
                UserAgent.UNKNOWN, "Windows NT", "4.0", "Chrome", "12.0.742.5"));
        // Assertion for Chrome browser
        assertUserAgentEquals(
                "Mozilla/5.0 (Windows NT 5.0) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/21.0.1180.77 Safari/537.1,platform,unknown",
                new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "5.0",
                        "Chrome", "21.0.1180.77"));
        // Assertion for Firefox browser
        assertUserAgentEquals(
                "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.0.4) Gecko/2008102920 Firefox/3.0.4,platform,unknown",
                new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "5.1",
                        "Firefox", "3.0.4"));
        // Assertion for Firefox browser
        assertUserAgentEquals("Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.0.19) Gecko/2010031422 YFF3 "
                ...
                UserAgent.UNKNOWN, "Windows NT", "5.1", "Firefox", "3.0.19"));
        // Assertion for Firefox browser
        assertUserAgentEquals("Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.1.13) Gecko/20100914 "
                ...
                UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "5.1", "Firefox", "3.5.13"));
        // Assertion for Firefox browser Bot
        assertUserAgentEquals("Mozilla/5.0 (Windows; U; Windows NT 5.1; en-GB; rv:1.9.2.24) Gecko/20111103 AskTbFTB/3.14.1.20007 "
                ...
                UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "5.1", "Firefox", "3.6.24"));
        // Assertion for Firefox Bot
        assertUserAgentEquals("Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.2) Gecko/20100115 AskTbARS/3.15.1.22229 "
                ...
                UserAgent.UNKNOWN, "Windows NT", "5.1", "Firefox", "3.6"));
        // Assertion for Iron browser
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/534.30 (KHTML, like Gecko) Iron/12.0.750.0 "
                ...
                UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "5.1", "Iron", "12.0.750.0"));
        // Assertion for Comodo_Dragon browser
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/534.30 (KHTML, like Gecko) Comodo_Dragon/12.1.0.0 "
                ...
                UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "5.1", "Comodo_Dragon", "12.1.0.0"));
        // Assertion for Comodo_Dragon browser
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/534.30 (KHTML, like Gecko) Comodo_Dragon/12.2.0.0 "
                ...
                UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "5.1", "Comodo_Dragon", "12.2.0.0"));
        // Assertion for Maxthon browser
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/535.12 (KHTML, like Gecko) Maxthon/3.0 Chrome/18.0.966.0 "
                ...
                UserAgent.UNKNOWN, "Windows NT", "5.1", "Maxthon", "3.0"));
        // Assertion for Maxthon browser
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/535.12 (KHTML, like Gecko) Maxthon/3.3.6.2000 "
                ...
                UserAgent.UNKNOWN, "Windows NT", "5.1", "Maxthon", "3.3.6.2000"));
        // Assertion for RockMelt browser
        assertUserAgentEquals(
                "Mozilla/5.0 (Windows NT 5.2; WOW64) AppleWebKit/535.7 (KHTML, like Gecko) RockMelt/0.16.91.483 Chrome/16.0.912.77 Safari/535.7,platform,unknown",
                new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "5.2",
        ...
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 6.1) AppleWebKit/534.51.22 (KHTML, like Gecko) Version/5.0.2 "
                ...
                UserAgent.UNKNOWN, "Windows NT", "6.1", "Safari", "533.18.5"));
        // Assertion for Safari browser
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 6.1) AppleWebKit/534.57.2 (KHTML, like Gecko) Version/5.1.7 "
                ...
                UserAgent.UNKNOWN, "Windows NT", "6.1", "Safari", "534.57.2"));
        // Assertion for Opera browser
        assertUserAgentEquals("Opera/9.80 (Windows NT 6.2; U; Edition IBIS; zh-cn) Presto/2.10.289 Version/12.00,platform,unknown",
                new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN, UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows NT", "6.2",
                        "Opera", "9.80"));
        // Assertion for Opera browser for Macintosh
        assertUserAgentEquals(
                "Opera/9.80 (Macintosh; Intel Mac OS X 10.8.1; U; nl) Presto/2.10.289 Version/12.02,platform,unknown",
        ...
        assertUserAgentEquals("101653 Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_4) AppleWebKit/534.57.2 (KHTML, like Gecko) "
                ...
                "Mac OS X", "10.7.4", "Safari", "534.57.2"));
