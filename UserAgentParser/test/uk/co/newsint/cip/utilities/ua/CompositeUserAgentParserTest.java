	...
	public void testAppleParse() throws Exception {
		...
		assertUserAgentEquals(
				"Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3_3 like Mac OS X; ja-JP)"
						...
						UserAgent.MOBILE, "Apple", "iPhone", "iPhone", "iOS",
						"4.3.3", "Mozilla", UserAgent.UNKNOWN));
		// Assertion for IPhone
		assertUserAgentEquals(
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.TABLET, "Apple", "iPad", "iPad", "iOS",
						"5.1.1", "Mobile Safari", UserAgent.UNKNOWN));
		// Assertion for iPad
		assertUserAgentEquals(
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.MOBILE, "Apple", "iPod", "iPod", "iOS",
	...
	public void testPCParse() throws Exception {
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows", "6.1",
						"MSIE", "9.0"));
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows", "5.1",
						"Firefox", "3.0.4"));
		// Assertion for Firefox browser
		assertUserAgentEquals(
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.COMPUTER, UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, UserAgent.UNKNOWN, "Windows", "5.2",
		...
		assertUserAgentEquals(
				...
				new UserAgent(UserAgent.COMPUTER, "Apple", UserAgent.UNKNOWN,
						UserAgent.UNKNOWN, "Mac OS X", "10.8.1", "Opera",
						"9.80"));
