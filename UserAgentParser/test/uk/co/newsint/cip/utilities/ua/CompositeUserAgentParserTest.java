...
public class CompositeUserAgentParserTest
{
    ...
    public void testBlackBerryParse() throws Exception
    {
        ...
        assertUserAgentEquals("BlackBerry8520/4.6.1.314 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/301", new UserAgent(
                UserAgent.MOBILE, "BlackBerry", "8520", "8520", "OS4", "4.6.1.314", "RIM", "BlackBerry",
    ...
    public void testAndroidParse() throws Exception
    {
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.MOBILE, "Samsung", "GT-I9100", UserAgent.UNKNOWN, "Android", "4.1.1",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.MOBILE, "SAMSUNG", "SGH-I727", UserAgent.UNKNOWN, "Android", "4.0.4", "Google",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.MOBILE, "HTC", "Sensation", UserAgent.UNKNOWN, "Android", "4.0.3", "Google", "Safari",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.MOBILE, "SAMSUNG", "GT-I9100", UserAgent.UNKNOWN, "Android", "4.0.3", "Google",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.MOBILE, "Samsung", "GT-I9300", UserAgent.UNKNOWN, "Android", "4.1.1",
        ...
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.TABLET, "ARCHOS", "101G9", UserAgent.UNKNOWN, "Android", "3.2.1", "Google", "Safari",
                        "4", UserAgent.UNKNOWN, UserAgent.UNKNOWN, "en", "GB"));
        // Assertion for Android Safari browser on HTC
        assertUserAgentEquals(
                ...
                new UserAgent(UserAgent.MOBILE, "HTC", "One S", UserAgent.UNKNOWN, "Android", "4.0.3", "Google", "Safari",
    ...
    public void testPCParse() throws Exception
    {
        ...
        assertUserAgentEquals("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/535.12 (KHTML, like Gecko) Maxthon/3.0 Chrome/18.0.966.0 "
                ...
                "Windows", "XP", "Microsoft", "Maxthon", "3", UserAgent.UNKNOWN, UserAgent.UNKNOWN,
                UserAgent.UNKNOWN, UserAgent.UNKNOWN));
        // Assertion for Chrome browser. The user agent has Maxthon, Chrome and Safari browser signature
